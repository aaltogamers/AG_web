...
export type EventSession = {
  // Optional label, e.g. "Qualifiers" or "Finals"
  name?: string
  start: string
  end: string
  location: string
  // Random id generated by the CMS on save
  id?: string
}

// Sign-up forms themselves are created in the admin panel
export type SignupMode = 'none' | 'event' | 'session'
